  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="flex flex-col gap-4 lg:flex-row lg:items-start">
        {/* Edit banner */}
        <div className="w-full rounded-xl border border-blue-200 bg-blue-50 p-3 lg:hidden">
          <Link
            href={`/admin/responses/${survey.id}/edit`}
        ...
        <div className="flex flex-1 flex-col gap-6">
          ...
          <ResponseDetailSection title="Skills & Training">
            <DetailGrid>
              ...
              <DetailRow label="Certification no.">
                {survey.certificationNumber ?? "—"}
              </DetailRow>
                  ...
                  >
                    ...
                    <p className="text-xs text-slate-600">
                      ...
                      <span className="font-medium text-slate-800">
                        {entry.actorName ?? entry.actorDisplay ?? "Applicant"}
                      </span>
                      {entry.actorEmail ? ` (${entry.actorEmail})` : ""}
                      {entry.actorType === "applicant" ? (
                        <span className="ml-1 rounded bg-amber-100 px-1.5 py-0.5 text-[10px] font-semibold uppercase tracking-wider text-amber-700">
                          Applicant
                        </span>
                      ) : null}
                    </p>
        ...
        <div className="w-full lg:sticky lg:top-8 lg:w-72 lg:shrink-0">
          <div className="flex flex-col gap-3">
            <div className="hidden rounded-xl border border-blue-200 bg-blue-50 p-3 lg:block">
              <Link
                href={`/admin/responses/${survey.id}/edit`}
                className="inline-flex items-center gap-2 text-sm font-semibold text-blue-700 hover:text-blue-800"
              >
                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" aria-hidden>
                  <path d="M11 2.5l2.5 2.5M2 14l3-1 8.5-8.5L11 2 2.5 10.5 2 14z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
                Edit application data
              </Link>
            </div>
