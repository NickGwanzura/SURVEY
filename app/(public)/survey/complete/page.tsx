...
type SearchParams = Promise<{ ref?: string; offline?: string; edited?: string }>;

export const metadata: Metadata = {
  title: "Thank you — RAC Technician Registry",
  description: "Your RAC Technician registration has been received.",
...
export default async function CompletePage({
  ...
  const isEdited = params.edited === "1";
  ...
  const description = isOffline
    ...
    : isEdited
      ? "Your application has been updated. The NOU and HEVACRAZ teams will review any changes."
      ...
      <section className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
        ...
        <ol className="mt-4 flex flex-col gap-3">
          {[
            ...
            "If you opted in, you may be contacted for verification or training programme invitations.",
            "Once verified, your details will appear in the public registry only if you gave explicit consent.",
          ].map((step, i) => (
