...
export function BackgroundStep({
  ...
  const originalPhone = useRef(defaultValues.phone);
  ...
  useEffect(() => {
    ...
    // Skip duplicate check when the phone hasn't changed from the original value
    // (e.g. when an admin is editing an existing application).
