...
// Format an ISO date or "YYYY-MM-DD" string to a readable short format
function formatDateLabel(raw: string): string {
  // If it's already a short label like "Jan 12", return as-is
    ...
    <ResponsiveContainer width="100%" height={height}>
      ...
      >
        ...
        <Tooltip
          ...
          formatter={(v: number | string) => [Number(v).toLocaleString(), seriesLabel]}
          contentStyle={{
            borderRadius: 8,
