...
export function certificateEmailHtml(
  ...
  const body = `
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
        ...
        <td align="center" style="padding-bottom:20px;">
          <div style="width:56px;height:56px;border-radius:50%;background:${BRAND_50};text-align:center;line-height:56px;display:inline-block;">
            <svg width="28" height="28" viewBox="0 0 28 28" fill="none" style="vertical-align:middle;">
              ...
              <circle cx="14" cy="14" r="3" fill="${BRAND_500}"/>
            </svg>
          </div>
        </td>
      </tr>
      <tr>
        <td align="center" style="padding-bottom:8px;">
          <h1 style="margin:0;font-size:22px;font-weight:700;color:${SLATE_900};">Certificate Issued</h1>
        </td>
      </tr>
      <tr>
        <td align="center" style="padding-bottom:24px;">
          <p style="margin:0;font-size:15px;color:${SLATE_600};line-height:1.6;">
            Congratulations, <strong>${firstName}</strong>! Your registration certificate has been issued.
          </p>
        </td>
      </tr>
      <tr>
        <td align="center" style="padding-bottom:24px;">
          <table role="presentation" cellpadding="0" cellspacing="0" style="display:inline-block;border-radius:12px;border:1px solid ${BRAND_100};background:${BRAND_50};">
            <tr>
              <td style="padding:14px 24px;text-align:center;">
                <p style="margin:0;font-size:10px;font-weight:700;letter-spacing:1.5px;text-transform:uppercase;color:${BRAND_700};">Registration Number</p>
                <p style="margin:4px 0 0;font-family:'SF Mono','Fira Code',monospace;font-size:20px;font-weight:600;color:${BRAND_600};letter-spacing:1px;">${registrationNumber}</p>
              </td>
            </tr>
          </table>
        </td>
      ...
      <tr>
        <td align="center" style="padding-bottom:24px;">
          <p style="margin:0;font-size:14px;color:${SLATE_600};line-height:1.6;">
            Your official certificate is attached to this email. You can also download it at any time from the RAC Registry portal.
          </p>
        </td>
      </tr>
      <tr>
        <td style="padding-bottom:8px;">
          <p style="margin:0;font-size:14px;color:${SLATE_600};line-height:1.6;">
            This certificate confirms your registration in the National RAC Technician Registry and may be presented as proof of registration when required.
          </p>
        </td>
      </tr>
      <tr>
        <td style="padding-top:8px;">
          <p style="margin:0;font-size:14px;color:${SLATE_600};line-height:1.6;">
            <strong>Next steps:</strong> Keep your certificate for your records. If your details change, please contact the NOU or HEVACRAZ office to update your registration.
          </p>
        </td>
      </tr>
    </table>
  `;
  return emailShell("Certificate Issued — RAC Technician Registry", body);
}
...
export async function sendCertificateEmail(
  ...
  const subject =
    `Your Registration Certificate (${registrationNumber}) — RAC Technician Registry`;
  return sendEmail(
    [to],
    subject,
    certificateEmailHtml(firstName, registrationNumber),
    [
      {
...
/* ------------------------------------------------------------------ */
/*  Email 6 — New Submission Alert (to Admins)                         */
/* ------------------------------------------------------------------ */
export function newSubmissionAlertEmailHtml(
  firstName: string,
  surname: string,
  province: string,
  referenceNumber: string,
    ...
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
      <tr>
        <td align="center" style="padding-bottom:20px;">
          <div style="width:56px;height:56px;border-radius:50%;background:${BRAND_50};text-align:center;line-height:56px;display:inline-block;">
            <svg width="28" height="28" viewBox="0 0 28 28" fill="none" style="vertical-align:middle;">
              <circle cx="14" cy="14" r="12" stroke="${BRAND_500}" stroke-width="2"/>
              <path d="M14 8v8M10 12h8" stroke="${BRAND_500}" stroke-width="2" stroke-linecap="round"/>
            </svg>
          </div>
        </td>
      </tr>
      <tr>
        <td align="center" style="padding-bottom:8px;">
          <h1 style="margin:0;font-size:22px;font-weight:700;color:${SLATE_900};">New Survey Submission</h1>
        </td>
      </tr>
      <tr>
        <td align="center" style="padding-bottom:24px;">
          <p style="margin:0;font-size:15px;color:${SLATE_600};line-height:1.6;">
            A new technician has submitted a registration to the RAC Technician Registry.
          </p>
        </td>
      </tr>
      <tr>
            ...
            <tr>
              <td style="padding:16px 20px;">
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                  <tr>
                    <td style="padding-bottom:8px;">
                      <p style="margin:0;font-size:11px;font-weight:700;letter-spacing:1.5px;text-transform:uppercase;color:${BRAND_700};">Applicant</p>
                      <p style="margin:4px 0 0;font-size:16px;font-weight:600;color:${SLATE_900};">${firstName} ${surname}</p>
                    </td>
                  </tr>
                  <tr>
                    <td style="padding-bottom:8px;">
                      <p style="margin:0;font-size:11px;font-weight:700;letter-spacing:1.5px;text-transform:uppercase;color:${BRAND_700};">Province</p>
                      <p style="margin:4px 0 0;font-size:15px;color:${SLATE_600};">${province}</p>
                    </td>
                  </tr>
                  <tr>
                    <td>
                      <p style="margin:0;font-size:11px;font-weight:700;letter-spacing:1.5px;text-transform:uppercase;color:${BRAND_700};">Reference</p>
                      <p style="margin:4px 0 0;font-family:'SF Mono','Fira Code',monospace;font-size:15px;font-weight:600;color:${BRAND_600};letter-spacing:1px;">${referenceNumber}</p>
                    </td>
                  </tr>
                </table>
              </td>
      ...
      <tr>
        <td align="center" style="padding-bottom:24px;">
          <table role="presentation" cellpadding="0" cellspacing="0">
            <tr>
              <td align="center" style="border-radius:8px;background:${BRAND_600};padding:14px 32px;">
                <a href="${dashboardUrl}" style="color:${WHITE};font-size:15px;font-weight:600;text-decoration:none;display:inline-block;">
                  Review Submission
                </a>
              </td>
            </tr>
      ...
      <tr>
        <td>
          <p style="margin:0;font-size:14px;color:${SLATE_600};line-height:1.6;">
            Log in to the admin portal to review, verify, or flag this submission.
          </p>
        </td>
      </tr>
    </table>
  `;
  return emailShell("New Submission — RAC Technician Registry", body);
}
...
export async function sendNewSubmissionAlertEmail(
  ...
  const dashboardUrl =
    process.env.NEXT_PUBLIC_SITE_URL
      ? `${process.env.NEXT_PUBLIC_SITE_URL}/admin/responses`
      : "/admin/responses";

  return sendEmail(
    [to],
    `New Submission: ${firstName} ${surname} — RAC Technician Registry`,
    newSubmissionAlertEmailHtml(firstName, surname, province, referenceNumber, dashboardUrl),
  );
}
...
export async function notifyAdminsOfNewSubmission(params: {
  ...
  try {
    ...
    if (failures.length > 0) {
      console.error(
        `[email] Failed to send ${failures.length}/${admins.length} admin alerts:`,
        failures.map((f) => (f as PromiseRejectedResult).reason),
      );
    }
  } catch (err) {
    console.error("[email] Error notifying admins of new submission:", err);
  }
}
